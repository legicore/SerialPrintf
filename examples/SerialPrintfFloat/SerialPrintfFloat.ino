////////////////////////////////////////////////////////////////////////////////
/**
 * @file        SerialPrintfFloat.ino
 *
 * @author      Martin Legleiter
 *
 * @brief       The library is implemented with the help of vsnprintf() which
 *              can't print floating point values via the specifier "%f".
 *              The following example shows how you can print a float value
 *              with SerialPrintf and the provided float specifier macros.
 * 
